<nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" data-bs-toggle="collapse" href="templates/forms/basic_elements.html" aria-expanded="false" aria-controls="ui-basic">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="pages/forms/basic_elements.html" aria-expanded="false" aria-controls="ui-basic">
              <span class="menu-icon">
